...
stow -vRt ~ shell ipython nvim bin tridactyl applications systemd task qutebrowser urlview tmux libinput-gestures jupyterlab zathura flake8 neomutt matplotlib kitty

# For sway
#stow -vRt ~ sway waybar mako defaults alacritty kitty libinput-gestures swaylock kanshi gammastep wofi
stow -vRt ~ kanshi mako waybar swaylock gammastep libinput-gestures sway defaults
